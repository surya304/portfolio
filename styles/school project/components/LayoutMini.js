...
const navigation = [
  ...
  { name: "Categories", href: "/category", icon: BookOpenIcon, current: false },
  { name: "Subjects", href: "/subjects", icon: SpeakerWaveIcon, current: false },
  { name: "Classes", href: "/classes", icon: CreditCardIcon, current: false },
  { name: "Teachers", href: "/teachers", icon: UserIcon, current: false },
  ...
  { name: "Marks", href: "/marks", icon: CheckIcon, current: false },
  {
    name: "Fees",
    href: "/feeStructure",
...
const userNavigation = [
  { name: "Profile", href: "/profile", goto: "profile" },
  { name: "Billing", href: "/billing", goto: "billing" },
  ...
  return (
    <div>
      ...
      <div className="hidden md:fixed md:inset-y-0 md:flex md:w-32 md:flex-col">
        ...
        <div className="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-gray-800 pt-2">
          <div className="flex flex-shrink-0 items-center px-4 justify-center">
            {/* <img
              ...
              alt="Your Company"
            /> */}
            <h2 className="text-xl sm:text-4xl text-white font-extrabold border border-gray-50 rounded-lg px-6 py-2">S</h2>
          </div>
            ...
            <nav className="flex-1 space-y-1 px-2 pb-4">
              {navigation.map((item) => (
                ...
                <a
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-yellow-500 text-white' : 'text-indigo-100 hover:bg-yellow-200 hover:text-gray-800',
                ...
                >
                  <item.icon
                    className={classNames(
                      item.current ? 'text-white' : 'text-white group-hover:text-gray-800',
                      'h-7 w-7'
                    )}
                    aria-hidden="true"
                  />
                  <span className="mt-2 text-xs w-full text-center">{item.name}</span>
                </a>
              ))}
            </nav>
          </div>
