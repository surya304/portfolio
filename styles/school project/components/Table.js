            ...
            <tbody className="divide-y divide-gray-200 bg-white text-center">
                      {tableVal.map((item, i) => (
                        ...
                        {Object.keys(item).map((keyName, i) => (
                          ...
                          <a onClick={(e) => editRow(e, item, i)} className="border-2 border-indigo-300 rounded-md text-indigo-600 hover:text-indigo-900 cursor-pointer">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-indigo-400" fill="none"
                            ...
                            <a onClick={() => deleteRow(item, i)} className="border-2 border-red-300 rounded-md ml-8 text-red-400 hover:text-red-500 cursor-pointer">
