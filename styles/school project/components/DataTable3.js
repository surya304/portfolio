        ...
        <Switch.Group as="div" className="flex items-center">
          <Switch
            ...
            className={classNames(
              value ? 'bg-green-500 focus:ring-green-500' : 'bg-red-500 focus:ring-red-500',
              ...
              <div>
                ...
                <div className="mt-1">
                  <input value={inputValue} onChange={onChange}
                    ...
                    id="reason"
                    className={classNames(
                      editable ? 'ring-1 ring-inset ring-gray-300' : 'ring-0 ring-inset ring-gray-300',
        ...
        <>
          ...
          {props.showPagination == true && (
            ...
            <div className="py-3 flex items-center justify-between">
              ...
              {limit && <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
