      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-6xl py-10">
          <div className="text-center">
            <h1
              ref={ref1}
              className={`text-6xl font-bold tracking-tight custom-text-color text-center sm:text-8xl ${
                inView1 ? 'translate-y-0' : 'translate-y-full'
            ...
            >
              ...
              <span className="absolute right-4 top-[-50px]">
                <Image
                  src="/images/star.png"
                  className="h-10 w-10 mt-5 mx-auto sm:h-20 sm:w-20"
                  alt="start"
                  width={100}
                  height={100}
                />
            ...
            <h1
              ref={ref2}
              className={`relative mt-5 text-6xl font-bold tracking-tight custom-text-color text-center sm:text-8xl ${
            ...
            <p
              ref={ref3}
              className={`mt-20 text-lg leading-8 custom-text-color font-semibold ${
                inView3 ? 'translate-y-5' : 'translate-y-full'
              } transition-transform duration-1000`}
            >
            ...
            <div className="flex justify-center space-x-4 mt-10">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="icon_style text-2xl text-black-500 rounded-full p-2 transition-colors duration-200 w-10"
              >
                <FaGithub className="cursor-pointer" />
              </a>
              <a
                title="Linkedin Profile"
                href="https://www.linkedin.com/in/surya185"
                target="_blank"
                rel="noreferrer"
                className="icon_style text-2xl text-black-500 rounded-full p-2 transition-colors duration-200 w-10"
              >
              ...
              <a
                title="Email Me"
                href="mailto:ksaisurya304@gmail.com"
                target="_blank"
                rel="noreferrer"
                className="icon_style text-2xl text-black-500 rounded-full p-2 transition-colors duration-200 w-10"
              >
